 ...
 * and are exposed to DSH agents as mcp__medical-technician__* (medical-technician
 * copy; DSH namespaces tools via the composition's serverName — serverInfo keeps
 * the upstream name and is cosmetic).
 *
